...
{
  return Glib::wrap(g_socket_connection_get_socket(gobj()));
}
...
#else
Glib::RefPtr<SocketAddress> SocketConnection::get_local_address(std::auto_ptr<Glib::Error>& error)
...
#else
Glib::RefPtr<const SocketAddress> SocketConnection::get_local_address(std::auto_ptr<Glib::Error>& error) const
#endif //GLIBMM_EXCEPTIONS_ENABLED
{
...
#else
Glib::RefPtr<SocketAddress> SocketConnection::get_remote_address(std::auto_ptr<Glib::Error>& error)
#endif //GLIBMM_EXCEPTIONS_ENABLED
{
  GError* gerror = 0;
...
#else
Glib::RefPtr<const SocketAddress> SocketConnection::get_remote_address(std::auto_ptr<Glib::Error>& error) const
#endif //GLIBMM_EXCEPTIONS_ENABLED
{
